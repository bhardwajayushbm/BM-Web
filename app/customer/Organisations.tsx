...
export default function Organizations() {
    return (
        <section className="w-full bg-white px-[82px] py-24">
            <div className="max-w-[1000px] mx-auto flex items-start justify-between gap-20">
                <div>
                    <h1 className="font-[Helvetica] font-normal text-[38px] leading-[1.2] text-black w-[505px] h-[92px]">
                        Why Organizations Choose BANGMETRIC
                    </h1>
                    <p className="font-[Helvetica] font-normal text-[18px] leading-[1.5] text-black w-[505px] h-[90px] mt-4">

                        They’re not looking for another implementation partner.
                        They’re looking for a thinking partner
                    </p>
                    <div className="relative">
                        <div className="absolute left-[17px] top-[10px] h-[200px] w-[1px] bg-black z-0" />
                        ...
                        <div className="flex flex-col gap-[28px] relative z-10">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="font-[Helvetica] font-normal text-[18px] leading-[1.2] text-black w-[508px]">
