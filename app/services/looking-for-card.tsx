...
export default function LookingForCard() {
  ...
  const items = [
    ...
    },
    {
      ...
      link: "/it", // 👈 CHANGE THIS TO YOUR PAGE
    },
    {
  ...
  return (
    ...
    >
      <div className="max-w-[1100px] mx-auto">
        ...
        <h2 className="text-center font-[Helvetica] text-black text-[24px] sm:text-[32px] md:text-[40px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 mt-8 sm:mt-10">
          {items.map((item, i) => (
            <motion.div
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => {
                if (item.link) router.push(item.link); // 👈 CLICK NAVIGATION
              }}
              className={`
                relative
                rounded-[10px]
