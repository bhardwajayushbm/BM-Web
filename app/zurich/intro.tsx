...
export default function ZurichReleasePage() {
    return (
        <section className="w-full bg-white flex justify-center px-4 md:px-8 lg:px-10 py-16">
            <div className="w-full max-w-[1290px] font-helvetica text-black">
                <h1 className="text-[30px] font-bold leading-[100%] mb-4">
                    Introduction
                </h1>

                <p className="text-[20px] font-normal leading-[110%] mb-4">
                ...
                <p className="text-[20px] font-normal leading-[110%] mb-8">
                ...
                <h2 className="text-[24px] font-bold leading-[100%] mb-4">
                    Key Benefits:
                </h2>

                <ul className="list-disc pl-6 text-[20px] leading-[110%] mb-10 space-y-2">
                ...
                <h2 className="text-[24px] font-bold leading-[100%] mb-6">
                ...
                <p className="text-[20px] font-normal leading-[110%] mb-10">
                ...
                <ul className="list-disc pl-6 text-[18px] leading-[110%] mb-10 space-y-2">
                ...
                <h3 className="text-[20px] font-bold leading-[100%] mb-2">
                    Daily
                </h3>
                <ul className="list-disc pl-6 text-[18px] leading-[110%] mb-6 space-y-2">
                    <li>
                ...
                <p className="text-[20px] font-bold leading-[110%] mb-2">
                ...
                <ul className="list-disc pl-6 text-[18px] leading-[140%] mb-6 space-y-2">
